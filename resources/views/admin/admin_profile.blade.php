        ...
        <div class="row">
            <div class="col-lg-4 col-xl-4">
                <div class="card text-center">
                    <div class="card-body">
                        <img src="{{ !empty($adminData->image) ? url('upload/admin_images/' . $adminData->image) : url('upload/no-image.png') }}"
            ...
            <div class="col-lg-8 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.update_admin_profile') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img id="showImg" src="{{ !empty($adminData->image) ? url('upload/admin_images/' . $adminData->image) : url('upload/no-image.png') }}"
                                        class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                                </div>
                            </div> <!-- end row -->
                            <div class="text-end">
