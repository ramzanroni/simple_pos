        ...
        <div class="auth-fluid-form-box">
            <div class="align-items-center d-flex h-100">
                <div class="p-3">
                    ...
                    <p class="text-muted mb-4">Enter your email address/phone/name and password to access account.</p>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('login') is-invalid @enderror" type="text" id="login" name="login"
                                placeholder="Name/Email/Phone" :value="old('login')" required autofocus>
                                @error('login')
