                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('employee.attendance.list') }}" class="btn btn-success">Attendance List</a>
                        </ol>
                    </div>
                        ...
                        <form action=" " method="post" id="myForm">
                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="text-center btn present_all text-black btn-success"
                                            style="display: table-cell;">Present</th>
                                        <th class="text-center btn leave_all text-black btn-success"
                                            style="display: table-cell;">Leave</th>
                                        <th class="text-center btn absent_all text-black btn-success"
